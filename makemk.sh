...
ROOT=/home/nots/Documents/school/inferno-os
SYSTARG=Linux
OBJTYPE=386
SYSTYPE=posix

# Mk needs to be configured and built for the host architecture. So *don't* source mkconfig.
...
echo Building libraries for target

source $ROOT/mkconfig
PLAT=$ROOT/$SYSTARG/$OBJTYPE

CC="p arm-linux-gnueabihf-gcc -c -I$PLAT/include -I$ROOT/include -I$ROOT/utils/include"
LD="p arm-linux-gnueabihf-gcc"
AR="p ar crvs"
RANLIB=":"	# some systems still require `ranlib'
